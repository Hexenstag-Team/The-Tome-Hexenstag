...
\input{skills/skills list/appraise}

\input{skills/skills list/balance}

\input{skills/skills list/bluff}

\input{skills/skills list/climb}

\input{skills/skills list/concentration}

\input{skills/skills list/craft}

\input{skills/skills list/decipher-script}

\input{skills/skills list/diplomacy}

\input{skills/skills list/disable-device}

\input{skills/skills list/disguise}

\input{skills/skills list/escape-artist}

\input{skills/skills list/forgery}

\input{skills/skills list/gather-information}

\input{skills/skills list/handle-animal}

\input{skills/skills list/heal}

\input{skills/skills list/hide}

\input{skills/skills list/intimidate}

\input{skills/skills list/jump}

\input{skills/skills list/knowledge}

\input{skills/skills list/listen}

\input{skills/skills list/move-silently}

\input{skills/skills list/perform}

\input{skills/skills list/profession}

\input{skills/skills list/ride}

\input{skills/skills list/search}

\input{skills/skills list/sense-motive}

\input{skills/skills list/sleight-of-hand}

\input{skills/skills list/speak-language}

\input{skills/skills list/spellcraft}

\input{skills/skills list/spot}

\input{skills/skills list/survival}

\input{skills/skills list/swim}

\input{skills/skills list/tumble}

\input{skills/skills list/use-magic-device}

\input{skills/skills list/use-rope}
\pagebreak