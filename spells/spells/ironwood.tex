...
\begin{description*}
\item[Level:] Drd 6
\item[Casting Time:] 1 minute/lb. created
\item[Range:] 0 ft.
\item[Effect:] An \textit{ironwood} object weighing up to 5 lb./level
\item[Duration:] One day/level (D)
\item[Saving Throw:] None
\item[Spell Resistance:] No
\item[Components:] V, S, M
\item[Arcane Material Component:] Wood shaped into the form of the intended \textit{ironwood}
\end{description*}
