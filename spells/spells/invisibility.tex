...
\begin{description*}
\item[Level:] Brd 2, Sor/Wiz 2, Trickery 2
\item[Casting Time:] 1 standard action
\item[Range:] Personal or touch
\item[Duration:] 1 min./level (D)
\item[Saving Throw:] Will negates (harmless) or Will negates (harmless, object)
\item[Spell Resistance:] Yes (harmless) or Yes (harmless, object)
