...
\item[Components:] V, XP
\item[Arcane Material Component:] When a \textit{wish} duplicates a spell with a material
\end{description*}
...
XP Cost: The minimum XP cost for casting \textit{wish} is 5,000 XP. When
