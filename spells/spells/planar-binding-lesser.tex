%%%%%%%%%%%%%%%%%%%%%%%%%
\spellentry{Planar Binding, Lesser}
%%%%%%%%%%%%%%%%%%%%%%%%%

\tagline{Conjuration (Calling) [see text]}
\begin{description*}
\item[Level:] Sor/Wiz 5
\item[Casting Time:] 10 minutes
\item[Range:] Close (25 ft. + 5 ft./2 levels); see text
\item[Duration:] Instantaneous
\item[Saving Throw:] Will negates
\item[Spell Resistance:] No and Yes; see text
\item[Components:] V, S
\end{description*}
