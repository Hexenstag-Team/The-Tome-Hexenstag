...
\tagline{Evocation [Fire or Cold]}
\begin{description*}
\item[Level:] Fire 5, Sor/Wiz 4, Sun 4
...
Chill Shield: The flames are cool to the touch. You take only half damage
from fire-based attacks. If such an attack allows a Reflex save for half damage,
you take no damage on a successful save.
Arcane Material Component: A bit of phosphorus for the \textit{warm shield;
