...
\item[Casting Time:] 12 hours
\item[Range:] 0 ft.
\item[Effect:] One duplicate creature
\item[Duration:] Instantaneous
\item[Saving Throw:] None
\item[Spell Resistance:] No
\item[Components:] V, S, M, XP
\item[Arcane Material Component:] The spell is cast over the rough snow or ice form,
\end{description*}
