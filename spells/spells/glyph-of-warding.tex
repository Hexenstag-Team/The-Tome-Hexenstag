...
\item[Spell Resistance:] No (object) and Yes; see text
...
Note: Magic traps such as \textit{glyph of warding} are hard to detect
...
Blast Glyph: A \textit{blast glyph} deals 1d8 points of damage per two
