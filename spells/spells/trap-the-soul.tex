...
\item[Casting Time:] 1 standard action or see text
\item[Range:] Close (25 ft. + 5 ft./2 levels)
\item[Duration:] Permanent; see text
\item[Saving Throw:] See text
\item[Spell Resistance:] Yes; see text
\item[Components:] V, S, M, (F); see text
\item[Arcane Material Component:] Before the actual casting of \textit{trap the soul}
\end{description*}
...
Spell Completion: First, the spell can be completed by speaking its final
