...
\tagline{Abjuration [Fire]}
\begin{description*}
\item[Level:] Drd 2, Sor/Wiz 4
...
\item[Arcane Material Component:] A half-pound of gold dust (cost 25 gp) sprinkled on
\end{description*}
...
share with friends.
Note: Magic traps such as \textit{fire trap} are hard to detect and disable.
