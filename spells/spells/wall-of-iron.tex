...
\item[Effect:] Iron wall whose area is up to one 5-ft. square/level; see text
\item[Duration:] Instantaneous
\item[Saving Throw:] See text
\item[Spell Resistance:] No
\item[Components:] V, S, M
\item[Arcane Material Component:] A small piece of sheet iron plus gold dust worth 50
\end{description*}
