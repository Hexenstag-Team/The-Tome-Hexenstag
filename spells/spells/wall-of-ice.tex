...
\item[Effect:] Anchored plane of ice, up to one 10-ft. square/level, or hemisphere
\item[Duration:] 1 min./level
\item[Saving Throw:] Reflex negates; see text
\item[Spell Resistance:] Yes
\item[Components:] V, S, M
\item[Arcane Material Component:] A small piece of quartz or similar rock crystal.
\end{description*}
...
10 minutes.
Ice Plane: A sheet of strong, hard ice appears. The wall is 1 inch thick
...
Hemisphere: The wall takes the form of a hemisphere whose maximum radius
