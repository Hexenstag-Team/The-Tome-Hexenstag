...
\begin{description*}
\item[Level:] Brd 1, Clr 1, Sor/Wiz 1
...
Summon Monster I List (and alignment): Celestial dog LG, Celestial owl LG, Celestial giant fire beetle NG, Celestial porpoise NG (aquatic environments only), Celestial badger CG, Celestial monkey CG, Fiendish dire rat LE, Fiendish raven LE, Fiendish medium monstrous centipede NE, Fiendish small monstrous scorpion NE, Fiendish hawk CE, Fiendish small monstrous spider CE, Fiendish octopus CE (aquatic environments only), Fiendish small viper CE
