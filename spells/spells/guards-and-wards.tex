...
\item[Casting Time:] 30 minutes
\item[Range:] Anywhere within the area to be warded
\item[Duration:] 2 hours/level (D)
\item[Saving Throw:] See text
\item[Spell Resistance:] See text
\item[Components:] V, S, M, F
\item[Arcane Material Component:] Burning incense, a small measure of brimstone and
\end{description*}
...
Fog: Fog fills all corridors, obscuring all sight, including darkvision,
...
No.
Arcane Locks: All doors in the warded area are \textit{arcane locked.
}Saving Throw: None. Spell Resistance: No.
Webs: Webs fill all stairs from top to bottom. These strands are identical
...
Lost Doors: One door per caster level is covered by a \textit{silent image
