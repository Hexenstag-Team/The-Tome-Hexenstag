...
\item[Effect:] Phantom watchdog
\item[Duration:] 1 hour/caster level or until discharged, then 1 round/caster
\item[Saving Throw:] None
\item[Spell Resistance:] No
\item[Components:] V, S, M
\item[Arcane Material Component:] A tiny silver whistle, a piece of bone, and a thread.
\end{description*}
