...
\item[Effect:] Visual figment that cannot extend beyond a 20-ft. cube + one 10-ft.
\item[Duration:] Permanent until triggered, then 1 round/level
\item[Arcane Material Component:] A bit of fleece and jade dust worth 25 gp.
\end{description*}
