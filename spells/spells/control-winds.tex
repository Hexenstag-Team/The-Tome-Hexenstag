...
\tagline{Transmutation [Air]}
\begin{description*}
\item[Level:] Air 5, Drd 5
\item[Casting Time:] 1 standard action
\item[Range:] 40 ft./level
...
limit.
Wind Direction: You may choose one of four basic wind patterns to function
...
Wind Strength: For every three caster levels, you can increase or decrease
