...
\tagline{Conjuration (Creation or Calling)}
\begin{description*}
\item[Level:] Clr 9, Sor/Wiz 9
\item[Casting Time:] 1 standard action
\item[Range:] Medium (100 ft. + 10 ft./level)
\item[Effect:] See text
\item[Duration:] Instantaneous or concentration (up to 1 round/level); see text
\item[Saving Throw:] None
\item[Spell Resistance:] No
\item[Components:] V, S, XP; see text
\end{description*}
...
Planar Travel: As a mode of planar travel, a \textit{gate} spell functions
...
Calling Creatures: The second effect of the \textit{gate} spell is to
...
Note: When you use a calling spell such as \textit{gate} to call an air,
chaotic, earth, evil, fire, good, lawful, or water creature, it becomes a spell
of that type.
XP Cost: 1,000 XP (only for the \textit{calling creatures} function).