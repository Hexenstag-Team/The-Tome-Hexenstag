...
\begin{description*}
\item[Level:] Drd 6, Fire 6, Sun 6
\item[Casting Time:] 1 standard action
\item[Range:] Touch
\item[Duration:] 10 min./level or until used
\item[Saving Throw:] None or Reflex half; see text
\item[Spell Resistance:] No
\item[Components:] V, S, M
\item[Arcane Material Component:] The acorns or holly berries.
\end{description*}
...
Acorn Grenades: As many as four acorns turn into special splash weapons
