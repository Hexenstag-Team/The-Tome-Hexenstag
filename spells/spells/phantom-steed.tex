...
\item[Range:] 0 ft.
\item[Effect:] One quasi-real, horselike creature
...
10th Level: The mount can use \textit{water walk} at will (as the spell,
no action required to activate this ability).
12th Level: The mount can use \textit{air walk} at will (as the spell,
