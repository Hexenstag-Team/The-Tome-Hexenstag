...
\item[Duration:] Concentration (up to 1 round/ level) or instantaneous; see text
\item[Saving Throw:] Will negates (object) or None; see text
\item[Spell Resistance:] Yes (object); see text
\item[Components:] V, S
\end{description*}
...
Sustained Force: A sustained force moves an object weighing no more than
...
checks.
Combat Maneuver: Alternatively, once per round, you can use \textit{telekinesis
