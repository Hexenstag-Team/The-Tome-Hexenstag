...
\item[Effect:] Colorful lights in a 20-ft.-radius spread
\item[Duration:] Concentration + 2 rounds
\item[Saving Throw:] None
\item[Spell Resistance:] Yes
\item[Components:] V, S, M
\item[Arcane Material Component:] A small crystal prism.
\end{description*}
...
6 or less: Unconscious for 1d4 rounds, then stunned for 1d4 rounds, and
then \textit{confused} for 1d4 rounds. (Treat an unconscious result as stunned
for nonliving creatures.)
7 to 12: Stunned for 1d4 rounds, then \textit{confused} for 1d4 rounds.
