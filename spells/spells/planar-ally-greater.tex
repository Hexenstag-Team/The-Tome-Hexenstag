%%%%%%%%%%%%%%%%%%%%%%%%%
\spellentry{Planar Ally, Greater}
%%%%%%%%%%%%%%%%%%%%%%%%%

\tagline{Conjuration (Calling) [see text for \textit{lesser planar ally}]}
\begin{description*}
\item[Level:] Clr 8
\item[Effect:] Up to three called elementals or outsiders, totaling no more than
\end{description*}
