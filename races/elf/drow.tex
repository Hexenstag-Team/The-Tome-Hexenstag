...
\item Daylight Sensitivity: While in brightly light surroundings (such as a \linkspell{daylight} spell), a Drow suffers a -2 penalty to attack rolls and precision-based skill checks.
\item Spell-Like Abilities: 1/day— \linkspell{Dancing Lights}, and \linkspell{Faerie Fire}. Caster level equals drow’s hit dices.
