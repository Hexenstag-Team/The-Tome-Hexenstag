...
\item Spell-Like Abilities: 1/day— \linkspell{Enlarge Person}, \linkspell{Invisibility}. Caster level equals to twice the duergar’s hit dices (minimum 3rd level). These abilities affect only the duergar and whatever she carries.
...
Underdark (Northdark) & Elven, Dwarven & \multicolumn{1}{p{5cm}}{\raggedright{}Draconic, Giant, Goblin, Orc, Terran} & \multicolumn{1}{p{5cm}}{\raggedright{}\linkfeat{Bullheaded}, \linkfeat{Daylight Adaptation}, \linkfeat{Thug}}\\
\end{smallbasictable}
