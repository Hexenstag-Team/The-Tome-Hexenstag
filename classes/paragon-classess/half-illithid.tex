...
\textbf{Class Skills:} The \currentclassname{}'s class skills are \linkskill{Bluff} (Cha), \linkskill{Concentration} (Con), \linkskill{Diplomacy} (Cha), \linkskill{Disguise} (Cha), \linkskill{Hide} (Dex), \linkskill{Intimidate} (Cha), \linkskill{Knowledge} (Int), \linkskill{Listen} (Wis), \linkskill{Sense Motive} (Wis), \linkskill{Spot} (Wis)
